            ...
            <div style={{ display: 'flex', alignItems: 'center', gap: '10px', marginTop: '2px' }}>
              <button
                ...
                style={{
                  ...
                  backgroundColor: playingRecording ? 'rgba(251,191,36,0.1)' : 'rgba(255,255,255,0.06)',
                  border: playingRecording ? '1px solid rgba(251,191,36,0.3)' : '1px solid rgba(255,255,255,0.12)',
              ...
              >
                <button
                  ...
                  style={{
                    ...
                    backgroundColor: isPlaying ? 'rgba(251,191,36,0.1)' : 'rgba(255,255,255,0.06)',
                    border: isPlaying ? '1px solid rgba(251,191,36,0.3)' : '1px solid rgba(255,255,255,0.12)',
                  ...
                  <>
                    ...
                    {labels.map((lbl, idx) => (
                      <button
                        ...
                        style={{
                          padding: '2px 5px', borderRadius: '3px', fontSize: '9px', fontWeight: 700,
                    ...
                    >
                      {isLoading ? <span style={{ width: '5px', height: '5px', borderRadius: '50%', border: '1.5px solid transparent', borderTopColor: 'var(--text-muted)', display: 'inline-block' }} />
                        : isPlaying ? <svg width="5" height="6" viewBox="0 0 8 9" fill="currentColor"><rect x="0" y="0" width="2.5" height="9" rx="0.5"/><rect x="5" y="0" width="2.5" height="9" rx="0.5"/></svg>
                        : <svg width="4" height="6" viewBox="0 0 7 9" fill="currentColor"><path d="M0.5 1L6.5 4.5L0.5 8V1Z"/></svg>}
                    </button>
